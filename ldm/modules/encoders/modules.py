...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(
        ...
        super().__init__()
        self.tokenizer = CLIPTokenizer.from_pretrained("/home/lc/Desktop/wza/ly/US-SD/stable-diffusion-v1-4/tokenizer" , local_files_only=True)
        self.transformer = CLIPTextModel.from_pretrained("/home/lc/Desktop/wza/ly/US-SD/stable-diffusion-v1-4/text_encoder")
        self.device = device
        self.max_length = max_length  # TODO: typical value?
        self.freeze()
