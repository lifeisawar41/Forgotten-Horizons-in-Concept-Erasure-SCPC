...
def certain_label(
    ...
    forget_dl, _ = setup_forget_data(class_to_forget, batch_size, image_size, max_samples_per_class=10)
    ...
    if mask_path:          #用不用mask决定了它是否采用论文Salun中的主要代码部分，random label都是通用的覆盖方法
